...
def _read_local_override(upc: str) -> Optional[Dict[str, Any]]:
    """
...
def _fetch_off(code: str) -> Optional[Dict[str, Any]]:
    """
...
def lookup_upc(code: str) -> Optional[Dict[str, Any]]:
    return lookup(code)

def resolve_upc(code: str) -> Optional[Dict[str, Any]]:
    return lookup(code)

def fetch(code: str) -> Optional[Dict[str, Any]]:
    return lookup(code)

def fetch_upc(code: str) -> Optional[Dict[str, Any]]:
    return lookup(code)

def search(code: str) -> Optional[Dict[str, Any]]:
    return lookup(code)
