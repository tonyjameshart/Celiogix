...
from typing import Iterable, Mapping, Dict, List, Tuple, Any, Optional
...
def normalize_headers(headers: Iterable[str], aliases: Optional[Mapping[str, str]] = None) -> List[str]:
    """
...
def normalize_row_keys(row: Mapping[str, Any], aliases: Optional[Mapping[str, str]] = None) -> Dict[str, Any]:
...
# Reading & writing
# --------------------------
def read_csv_rows(path: str | Path, aliases: Optional[Mapping[str, str]] = None, *, keep_unknown_headers: bool = True) -> Tuple[List[str], List[Dict[str, Any]]]:
    """
...
def write_csv_rows(path: str | Path, headers: Iterable[str], rows: Iterable[Mapping[str, Any]]) -> None:
    """
...
def export_table_to_csv(path: str | Path, headers: List[str], records: Iterable[Iterable[Any]]) -> None:
    """
