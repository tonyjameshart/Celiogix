...
class ScrollFrame(ttk.Frame):
    ...
    def _yset(self, first, last):
        self.vbar.set(first, last); self._maybe_hide_bars()

    def _xset(self, first, last):
        self.hbar.set(first, last); self._maybe_hide_bars()
    ...
    def _on_linux_up(self, _event):  self.canvas.yview_scroll(-1, "units")
    def _on_linux_down(self, _event): self.canvas.yview_scroll( 1, "units")
